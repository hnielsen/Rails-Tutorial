...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the users's microposts" do
      p1 = Factory(:micropost, :user => @user, :content => "Foo bar 1")
      p2 = Factory(:micropost, :user => @user, :content => "Foo bar 2")
      get :show, :id => @user
    ...
    it "should paginate microposts" do
      ...
      p2 = Factory(:micropost, :user => @user, :content => "Foo bar 2")
      30.times do
        Factory(:micropost, :user => @user, :content => "Lorem ipsum dolor")
      end
      get :show, :id => @user
      response.should have_selector "div.pagination"
      response.should have_selector("span.disabled", :content => "Previous")
  ...
  describe "GET 'new'" do
    ...
    # Checking for presence of fields in this way seems vulnerable to implementation details like the name of the 
    # fields in the generated html from the views. Don't waste time maintaining if this changes and breaks the 
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Test User Edited", :email => "test2@example.com", 
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show the user following the other user" do
        get :following, :id => @user
        response.should have_selector("a", :href => user_path(@other_user), :content => @other_user.name)
      end

      it "should show the users followers" do
